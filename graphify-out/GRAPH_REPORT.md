...
## Corpus Check
- 515 files · ~464,013 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2203 nodes · 6812 edges · 156 communities (139 shown, 17 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `31af82bf`
...
Cohesion: 0.02
Nodes (77): AuthProvider(), AgenticWorkflows, AIClosingAssistant, AIGrowthHacker, AIInsights, AIMissionControl, AIOpsDashboard, AllLeads (+69 more)

### Community 2 - "Community 2"
Cohesion: 0.13
Nodes (40): HealthcareLeadsTableProps, InsuranceLeadsTableProps, ColumnConfigItem, ProfileLevel, RealEstateLeadsTableProps, SaaSLeadsTableProps, SiteVisitCameraDialog(), TravelLeadsTableProps (+32 more)
...
Cohesion: 0.13
Nodes (32): ActionCenter(), ActionCenterProps, useActionCenter(), DEFAULT_INSURANCE_CONFIG, InsuranceLeadProfiling(), ProfileLevel, ProfilingConfig, Battlecard (+24 more)
...
Cohesion: 0.09
Nodes (39): HealthcareAssignLeadsDialog(), HealthcareLeadDetailsDialog(), HealthcareLeadsTable(), HealthcareUploadLeadsDialog(), InsuranceAssignLeadsDialog(), InsuranceLeadDetailsDialog(), InsuranceUploadLeadsDialog(), SaaSAssignLeadsDialog() (+31 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (37): formSchema, HealthcareEditLeadDialogProps, formSchema, RealEstateAddLeadDialogProps, formSchema, RealEstateEditLeadDialogProps, formSchema, TravelAddLeadDialogProps (+29 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (31): CreateAutomationDialogProps, HealthcareAssignLeadsDialogProps, Profile, Props, OwnerType, Profile, RealEstateAssignLeadsDialogProps, Profile (+23 more)
...
Cohesion: 0.15
Nodes (22): RealEstateAssignLeadsDialog(), RealEstateLeadsTable(), Company, fetchCompanyData(), useUpdateLead(), UseRealEstateLeadsOptions, ColumnConfig, ColumnConfigDialog() (+14 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (26): SubscriptionExpiredBanner(), ALLOWED_EXPIRED_PATHS, SubscriptionExpiredGuard(), useAnnouncements(), useNotifications(), useReminderPolling(), useSubscriptionStatus(), AppRole (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.07
Nodes (25): HealthcareLeadDetailsDialogProps, HealthcareLead, Props, InsuranceLead, RealEstateLeadDetailsDialog(), RealEstateLeadDetailsDialogProps, RealEstateLead, SaaSLeadDetailsDialogProps (+17 more)

### Community 15 - "Community 15"
Cohesion: 0.17
Nodes (22): DocumentView(), SendDocumentDialog(), Product, ProductInput, useProducts(), useQuotations(), ManageInsurancePlans(), CURRENCIES (+14 more)

### Community 16 - "Community 16"
Cohesion: 0.21
Nodes (17): UploadProgress, UploadProgress, UploadProgress, AddIntegrationDialogProps, EmailAccountAddDialogProps, EmailIntegrationDialogProps, WhatsAppAccountAddDialogProps, UploadProgress (+9 more)

### Community 17 - "Community 17"
Cohesion: 0.12
Nodes (15): UnlockFeatureModal(), UnlockFeatureModalProps, SendDocumentDialogProps, useWalletBalance(), GoogleAdsSetupDialogProps, LinkedInAdsSetupDialogProps, Integration, PerformanceMarketingDialog() (+7 more)

### Community 18 - "Community 18"
Cohesion: 0.1
Nodes (26): HealthcareAddLeadDialog(), HealthcareEditLeadDialog(), InsuranceAddLeadDialog(), InsuranceEditLeadDialog(), InsuranceLeadsTable(), RealEstateAddLeadDialog(), RealEstateEditLeadDialog(), SaaSAddLeadDialog() (+18 more)

### Community 19 - "Community 19"
Cohesion: 0.1
Nodes (23): nodeTypes, WorkflowCanvas(), WorkflowCanvasProps, AIMetadata, callGemini(), cleanAIResponse(), getGeminiKey(), ActionType (+15 more)

### Community 20 - "Community 20"
Cohesion: 0.09
Nodes (21): adminClient, cleanedJson, result, userIds, adminClient, url, supabaseAdmin, url (+13 more)

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (16): DialogMode, LocationData, SiteVisitCameraDialogProps, Announcement, AuthContext, AuthContextType, GracePeriodData, SubscriptionStatus (+8 more)
...
Cohesion: 0.12
Nodes (24): useToast(), InvoiceSettings, InvoiceTax, InvoiceTemplate, useInvoiceSettings(), useInvoiceTaxes(), useInvoiceTemplates(), PropertyFormData (+16 more)

### Community 24 - "Community 24"
Cohesion: 0.17
Nodes (21): RealEstateUploadLeadsDialog(), useAuth(), useBookingPage(), useCalendarConnection(), useCalendarEvents(), useConnectGoogleCalendar(), useCreateBookingPage(), useExchangeCalendarCode() (+13 more)
...
Cohesion: 0.1
Nodes (20): Form, FormInsert, FormUpdate, LeadResponse, useCreateForm(), useFormResponses(), useUpdateForm(), AppRole (+12 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (18): AccountsTab(), InboxTab(), EmailAccount, PROVIDER_DEFAULTS, useEmailAccounts(), EmailMessage, EmailThread, useEmailInbox() (+10 more)
...
Cohesion: 0.16
Nodes (12): AIEmployee, useAIEmployees(), useWhatsAppAccounts(), WhatsAppAccount, CampaignRecipient, useWhatsAppCampaigns(), WhatsAppCampaign, WhatsAppAccountAddDialog() (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.16
Nodes (15): ActionItem, Lead, LeadStatus, useCreateLead(), useCreateLeads(), useDeleteLead(), UseLeadsOptions, useLeadsTable() (+7 more)
...
Cohesion: 0.13
Nodes (14): formSchema, HealthcareAddLeadDialogProps, HEALTHCARE_DEPARTMENTS, HEALTHCARE_GENDERS, HEALTHCARE_LEAD_COLUMNS, HEALTHCARE_STATUSES, HealthcareLeadFields, INSURANCE_LEAD_COLUMNS (+6 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (12): SubdomainAccessGuard(), SubdomainAccessGuardProps, SubdomainContext, SubdomainContextType, SubdomainProvider(), DomainClassification, getWorkspaceUrl(), PLATFORM_SUBDOMAINS (+4 more)
...
Cohesion: 0.24
Nodes (10): useDeleteForm(), useFormResponseCounts(), useForms(), GrowthSettings, useGrowthSettings(), LGLink, useLGLinks(), AIGrowthHacker() (+2 more)

### Community 36 - "Community 36"
Cohesion: 0.15
Nodes (10): Lead, LeadDetailsDialogProps, EmailMessage, ViewMode, Channel, GeneratedMessage, Tone, Step (+2 more)

### Community 37 - "Community 37"
Cohesion: 0.2
Nodes (14): LeadMobileCard(), KanbanLeadCard(), cn(), AIMissionControl(), CommandShortcut(), DropdownMenuShortcut(), PremiumCard(), PremiumCardContent() (+6 more)
...
Cohesion: 0.23
Nodes (15): useIsMobile(), STATUS_PROBABILITIES, useForecast(), useLeads(), useRealEstateLeads(), useUserRole(), AppLayout(), AutoDialer() (+7 more)
...
Cohesion: 0.21
Nodes (10): SubdomainGate(), SubdomainGateProps, CompanyBrandingContext, CompanyBrandingContextType, CompanyBrandingProvider(), useCompanyBranding(), useSubdomainContext(), Auth() (+2 more)
...
Cohesion: 0.14
Nodes (11): adminClient, authHeader, corsHeaders, delayMs, lastSent, projectId, resolvedBody, resolvedSubject (+3 more)
...
Cohesion: 0.24
Nodes (10): formSchema, SaaSAddLeadDialogProps, formSchema, SaaSEditLeadDialogProps, COMPANY_SIZES, DEAL_STAGES, LOSS_REASONS, PLAN_TYPES (+2 more)
...
Cohesion: 0.16
Nodes (9): adminClient, aiResponse, geminiKey, results, thresholdDate, authHeader, newFeatures, supabaseAdmin (+1 more)
...
Cohesion: 0.24
Nodes (7): calculateLeadScore(), calculatePriorityLevel(), PriorityLevel, ScoringResult, useLeadScoring(), PriorityBadge(), PriorityBadgeProps
...
Cohesion: 0.28
Nodes (6): AddIntegrationDialog(), Automations(), EXAMPLE_AUTOMATIONS, Integrations(), integrationTypes, Switch
...
## Knowledge Gaps
- **1120 isolated node(s):** `__dirname`, `supabase`, `options`, `mockSupabase`, `leads` (+1115 more)
...
- **Why does `useCompany()` connect `Community 6` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 21`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 33`, `Community 36`, `Community 37`, `Community 48`, `Community 50`, `Community 51`, `Community 57`, `Community 78`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 17` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 29`, `Community 30`, `Community 31`, `Community 32`, `Community 34`, `Community 35`, `Community 36`, `Community 37`, `Community 50`, `Community 51`, `Community 53`, `Community 57`, `Community 64`, `Community 78`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 37` to `Community 0`, `Community 129`, `Community 130`, `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 131`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 17`, `Community 22`, `Community 25`, `Community 30`, `Community 36`, `Community 52`, `Community 58`, `Community 62`, `Community 65`, `Community 77`, `Community 78`, `Community 84`, `Community 85`, `Community 124`?**
