...
## Corpus Check
- 515 files · ~463,783 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2203 nodes · 6808 edges · 147 communities (133 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5028751`
...
Cohesion: 0.08
Nodes (42): CreateAutomationDialogProps, HealthcareAssignLeadsDialogProps, Profile, Props, OwnerType, Profile, RealEstateAssignLeadsDialogProps, Profile (+34 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (49): CreateAutomationDialog(), INDUSTRY_ID, getIndustryById(), getIndustryName(), INDUSTRIES, Industry, IndustryType, INDUSTRY_ID (+41 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (47): formSchema, HealthcareEditLeadDialogProps, formSchema, InsuranceAddLeadDialogProps, formSchema, Props, formSchema, RealEstateEditLeadDialogProps (+39 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (44): HealthcareLeadDetailsDialog(), HealthcareLeadDetailsDialogProps, HealthcareLead, HealthcareLeadsTableProps, Props, InsuranceLead, InsuranceLeadsTableProps, RealEstateLeadDetailsDialog() (+36 more)
...
Cohesion: 0.13
Nodes (32): ActionCenter(), ActionCenterProps, useActionCenter(), DEFAULT_INSURANCE_CONFIG, ProfileLevel, ProfilingConfig, LeadTimeline(), LeadTimelineProps (+24 more)

### Community 8 - "Community 8"
Cohesion: 0.1
Nodes (43): HealthcareAssignLeadsDialog(), HealthcareUploadLeadsDialog(), InsuranceAssignLeadsDialog(), InsuranceUploadLeadsDialog(), RealEstateAssignLeadsDialog(), RealEstateUploadLeadsDialog(), SaaSAssignLeadsDialog(), SaaSUploadLeadsDialog() (+35 more)

### Community 9 - "Community 9"
Cohesion: 0.16
Nodes (29): InsuranceLeadDetailsDialog(), HealthcareAllLeads(), useIsMobile(), useDebounce(), useHealthcareLeads(), UseHealthcareLeadsOptions, AppRole, HierarchyUser (+21 more)
...
Cohesion: 0.13
Nodes (28): useDeleteForm(), useFormResponseCounts(), QueryResponse, TableSchema, Forms(), statusConfig, Company, DiscountCode (+20 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (31): useToast(), PropertyFormData, RealEstateProperty, useRealEstateProperties(), AddIntegrationDialog(), GoogleAdsSetupDialog(), LinkedInAdsSetupDialog(), MetaAdsSetupDialog() (+23 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (28): NavLink, NavLinkCompatProps, PriorityLevel, KanbanLeadCard(), PriorityBadge(), PriorityBadgeProps, cn(), Avatar (+20 more)

### Community 15 - "Community 15"
Cohesion: 0.2
Nodes (20): UploadProgress, UnlockFeatureModalProps, SendDocumentDialogProps, AddIntegrationDialogProps, EmailIntegrationDialogProps, GoogleAdsSetupDialogProps, LinkedInAdsSetupDialogProps, WhatsAppAccountAddDialogProps (+12 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (33): SheetContent, SheetContentProps, SheetDescription, SheetFooter(), SheetHeader(), SheetOverlay, SheetTitle, sheetVariants (+25 more)
...
Cohesion: 0.09
Nodes (25): SubscriptionExpiredBanner(), ALLOWED_EXPIRED_PATHS, SubscriptionExpiredGuard(), useAnnouncements(), GracePeriodData, SubscriptionStatus, useSubscriptionStatus(), AppRole (+17 more)
...
Cohesion: 0.1
Nodes (16): DialogMode, LocationData, SiteVisitCameraDialogProps, UnlockFeatureModal(), Announcement, AuthContext, AuthContextType, useWalletBalance() (+8 more)

### Community 24 - "Community 24"
Cohesion: 0.09
Nodes (21): aiAction, newHistory, supabase, userIds, adminClient, url, supabaseAdmin, url (+13 more)
...
Cohesion: 0.12
Nodes (15): formSchema, HealthcareAddLeadDialogProps, HEALTHCARE_DEPARTMENTS, HEALTHCARE_GENDERS, HEALTHCARE_LEAD_COLUMNS, HEALTHCARE_STATUSES, HealthcareLeadFields, INSURANCE_LEAD_COLUMNS (+7 more)

### Community 29 - "Community 29"
Cohesion: 0.18
Nodes (12): AccountsTab(), InboxTab(), AIEmployee, useAIEmployees(), EmailAccount, PROVIDER_DEFAULTS, useEmailAccounts(), EmailMessage (+4 more)

### Community 30 - "Community 30"
Cohesion: 0.13
Nodes (16): Form, FormInsert, FormUpdate, LeadResponse, useCreateForm(), useFormResponses(), useUpdateForm(), FormBuilder() (+8 more)

### Community 31 - "Community 31"
Cohesion: 0.17
Nodes (12): SubdomainAccessGuard(), SubdomainAccessGuardProps, SubdomainGate(), SubdomainGateProps, CompanyBrandingContext, CompanyBrandingContextType, CompanyBrandingProvider(), useCompanyBranding() (+4 more)
...
Cohesion: 0.17
Nodes (10): useWhatsAppAccounts(), WhatsAppAccount, CampaignRecipient, useWhatsAppCampaigns(), WhatsAppCampaign, WhatsAppAccountAddDialog(), AgenticWorkflows(), AccountsTab() (+2 more)
...
Cohesion: 0.16
Nodes (11): ACTION_TEMPLATES, AIWorkflow, AutonomyMode, DEFAULT_STEP, OUTCOME_OPTIONS, OutcomeGoal, TRIGGER_OPTIONS, TriggerType (+3 more)

### Community 48 - "Community 48"
Cohesion: 0.19
Nodes (9): ActionItem, Lead, calculateLeadScore(), calculatePriorityLevel(), ScoringResult, useLeadScoring(), KanbanStatusColumn(), LeadsKanbanBoardProps (+1 more)
...
Cohesion: 0.32
Nodes (7): useForms(), GrowthSettings, useGrowthSettings(), LGLink, useLGLinks(), AIGrowthHacker(), LGDashboard()

### Community 53 - "Community 53"
Cohesion: 0.17
Nodes (9): Company, fetchCompanyData(), useInsuranceLeads(), UseInsuranceLeadsOptions, useSaaSLeads(), UseSaaSLeadsOptions, useTravelLeads(), UseTravelLeadsOptions (+1 more)

### Community 54 - "Community 54"
Cohesion: 0.26
Nodes (9): formSchema, SaaSAddLeadDialogProps, UploadProgress, COMPANY_SIZES, DEAL_STAGES, LOSS_REASONS, PLAN_TYPES, SAAS_STATUSES (+1 more)
...
Cohesion: 0.29
Nodes (7): Notification, useNotifications(), subscribeToPush(), urlBase64ToUint8Array(), isSupported(), requestWebNotificationPermission(), sendWebNotification()
...
Cohesion: 0.31
Nodes (7): formSchema, RealEstateAddLeadDialogProps, UploadProgress, REAL_ESTATE_PROPERTY_TYPES, REAL_ESTATE_PURPOSES, REAL_ESTATE_STATUSES, RealEstateLeadFields
...
- **Why does `useCompany()` connect `Community 8` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 30`, `Community 31`, `Community 33`, `Community 46`, `Community 47`, `Community 53`, `Community 54`, `Community 61`, `Community 72`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `Button` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 20`, `Community 23`, `Community 26`, `Community 28`, `Community 29`, `Community 31`, `Community 32`, `Community 33`, `Community 46`, `Community 47`, `Community 48`, `Community 52`, `Community 54`, `Community 60`, `Community 61`, `Community 72`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `cn()` connect `Community 14` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 12`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 25`, `Community 26`, `Community 47`, `Community 48`, `Community 58`, `Community 79`?**
