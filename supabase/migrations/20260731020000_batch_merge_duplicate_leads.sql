-- Migration: Add batch_limit and has_more to merge_duplicate_leads to avoid statement timeouts on large datasets
...
DECLARE
  ...
  v_merged_json jsonb;
  v_newest_id uuid;
  v_effective_limit int := COALESCE(batch_limit, 200);
